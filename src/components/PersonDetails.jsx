    ...
    return info ? (
        <div className="px-[5%] w-screen h-[150vh] bg-[#1F1E24] ">
            <nav className="h-[10vh] w-full text-zinc-100 flex items-center gap-10 text-xl ">
                <Link
                    onClick={() => navigate(-1)}
                    className="hover:text-[#C1121F] text-2xl ri-arrow-left-line"
                ></Link>
            </nav>
            ...
            <div className="w-full flex flex-col md:flex-row">
                <div className="w-[100%] md:w-[20%]">
                    <img
                        ...
                        alt=""
                    />
                    <h1 className="text-3xl md:hidden block text-zinc-400 font-black my-5">
                        {info.detail.name}
                    </h1>
                ...
                <div className="w-[100%] md:w-[80%]">
                    <h1 className="text-6xl hidden md:block text-zinc-400 font-black my-5">
                        {info.detail.name}
                    </h1>
                    ...
                    <div className="list-disc mb-10 text-zinc-400 w-full h-[50vh] mt-5 overflow-x-hidden overflow-y-auto shadow-xl  border-2 border-zinc-700 p-5">
